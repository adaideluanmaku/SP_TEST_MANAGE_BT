...
// 格式示例："http://127.0.0.1/PASSPharmReview"
this.mcPrWebServiceUrl = "http://172.18.7.92/PASSPharmReview";
this.RefPlatformURL = "http://172.18.7.92/PASSDoctorQuery/Home/Index?loginkey=";
...
this.mc_passim_proxy_url = 'http://127.0.0.1/PASSPharmReview/mc_passim_proxy.html';//HIS服务器存放mc_passim_proxy绝对路径
...
this.MC_Close_Time = 10; //10秒钟后关闭提示