...
var TableInit =function () {
	...
	var address=addurl+"/pass/project_query";
...
function add_data(){
	...
	var queryaddress=addurl+'/pass/project_query';
	var addaddress=addurl+'/pass/project_add';
...
function del_data(){
	...
	swal({
    	...
    	var queryaddress=addurl+'/pass/project_query';
    	var deladdress=addurl+'/pass/project_del';
...
function update_data(){
	var queryaddress=addurl+'/pass/project_query';
	var addaddress=addurl+'/pass/project_update';
	$.ajax({
		type:"POST",
		url:addaddress,
		async:false,
