...
var TableInit =function () {
	...
	var address=addurl+"/pa/project_query";
...
function teamgroup(){
	var address = addurl + '/pa/teamgroup';
...
function add_data(){
	...
	var queryaddress=addurl+'/pa/project_query';
	var addaddress=addurl+'/pa/project_add';
...
function del_data(){
	...
	swal({
    	...
    	var queryaddress=addurl+'/pa/project_query';
    	var deladdress=addurl+'/pa/project_del';
...
function update_data(){
	var queryaddress=addurl+'/pa/project_query';
	var addaddress=addurl+'/pa/project_update';
	$.ajax({
		type:"POST",
		url:addaddress,
		async:false,
