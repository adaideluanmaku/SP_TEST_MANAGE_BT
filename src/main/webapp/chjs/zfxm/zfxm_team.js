...
var TableInit =function () {
	...
	var address=addurl+"/zfxm/team_query";
...
function add_data(){
	var queryaddress=addurl+'/zfxm/team_query';
	var addaddress=addurl+'/zfxm/team_add';
...
function del_data(){
	...
	swal({
    	...
    	var queryaddress=addurl+'/zfxm/team_query';
    	var deladdress=addurl+'/zfxm/team_del';
...
function update_data(){
	var queryaddress=addurl+'/zfxm/team_query';
	var addaddress=addurl+'/zfxm/team_update';
	$.ajax({
		type:"POST",
		url:addaddress,
		async:false,
