...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/zfxm/zfxm_testmng.js"></script>
					...
					<div class="col-sm-12">
					    ...
					    <div  class="btn-group">
							<button id="dropdownMenu1" type="button"
								...
								<span class="glyphicon glyphicon-sort-by-attributes" aria-hidden="true"></span>MEDEX TOOLS
							</button>
							<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								<li><a href="#" onclick="open_modal_dialog_HIS_data()">MCDEX TOOLS</a></li>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="height:400px;overflow:auto">
				<div class="row" style="margin-bottom : 15px">
					<h4>将数据导入到SQLSERVER数据库，模拟HIS数据。</h4><br>
				...
				<div class="row" style="margin-bottom : 15px">
					<div class="col-sm-8">
				        ...
				        <div class="input-group">
				            <span class="input-group-addon">循环1次数据集</span>
				            <select id='projectid1' name="projectid" class="form-control m-b js-data-example-ajax" style="width:100%"></select>
			            </div>
				    </div>
				</div>
				<div class="row" style="margin-bottom : 15px">
				...
				<div class="row" style="margin-bottom : 15px">
					<div class="col-sm-8">
				      	<div class="input-group">
				            <span class="input-group-addon">清空字典表</span>
				            <select class="form-control m-b" name="cy1" id="cleardict1">
	                            <option value="0" selected="selected"><font style="vertical-align: inherit;">关</font></option>
	                            <option value="1"><font style="vertical-align: inherit;">开</font></option>
	                        </select>
				        </div>
