...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/works/works_yuehuibao.js"></script>
		...
		<div id="header_path" class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				<ol class="breadcrumb">
					<li><a>home</a></li>
					<li><a>工作计划</a></li>
					<li class="active"><strong>月汇报</strong></li>
				</ol>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="height:400px;overflow:auto">
				<form class="form-horizontal" role="form" id="dialog_form">
					<input type="hidden" id="workyuehuibaoid" name="workyuehuibaoid" value="">
