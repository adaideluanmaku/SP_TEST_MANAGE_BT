			...
			<ul class="nav metismenu" id="side-menu">
				...
				<li><a href="index.html#"> <i class="fa fa-bar-chart-o"></i><span
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="javascript:void(0);" onclick="pass_team()">团队维护</a></li>
						<li><a href="javascript:alert(1);">项目维护</a></li>
						<li><a href="javascript:alert(1)">案例维护</a></li>
						<li><a href="javascript:alert(1)">用药研究</a></li>
					</ul></li>
				<li><a href="index.html#"> <i class="fa fa-bar-chart-o"></i><span
						class="nav-label">PA测试管理</span> <span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="javascript:void(0);" onclick="pa_graph()">PA统计</a></li>
						<li><a href="javascript:alert(1)">团队维护</a></li>
						<li><a href="javascript:alert(1)">项目维护</a></li>
						<li><a href="javascript:alert(1)">案例维护</a></li>
						<li><a href="javascript:alert(1)">用药研究</a></li>
					</ul></li>
