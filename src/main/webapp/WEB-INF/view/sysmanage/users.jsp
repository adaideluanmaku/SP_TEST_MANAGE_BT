...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/sysmanage/users.js"></script>
			...
			<div id="table_div" class="panel-body" style="padding-bottom:0px;">
				<div id="search_div" class="panel panel-default">
				    ...
				    <div class="panel-body">
				    	<div class="col-sm-5">
			                <label class="control-label col-sm-4" for="search_data" style="padding-top:7px">用户名</label>
			                <div class="col-sm-8">
			...
			<div class="modal-body" style="height:400px;overflow:auto">
				<form class="form-horizontal" role="form" id="dialog_form">
					...
					<div class="form-group">
			            ...
			            <div class="col-sm-4">
			            	<select id='state' name="state" class="js-example-responsive" style="width:100%"></select>
			            </div>
			        </div>
				</form>
			</div>
