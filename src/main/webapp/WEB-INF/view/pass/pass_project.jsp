...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/pass/pass_project.js"></script>
			...
			<div id="table_div" class="panel-body" style="padding-bottom:0px;">
				<div id="search_div" class="panel panel-default">
				    ...
				    <div class="panel-body">
				    	<div class="col-sm-3">
			                <label class="control-label col-sm-4" for="projectname" style="padding-top:7px">项目名称</label>
			                <div class="col-sm-8">
