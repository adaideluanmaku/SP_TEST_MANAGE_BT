...
public class Clear_mc {
	private static Logger log = Logger.getLogger(Clear_mc.class);
	JdbcTemplate jdbcTemplate=null;
	@Autowired
	DataBaseType dataBaseType;
	
	public void cleardatemz(int database) {
		...
		log.info("======>开始清理门诊业务数据 ");
		String[] sqls={
				"truncate table t_mc_clinic_allergen",
				"truncate table t_mc_clinic_cost",
				"truncate table t_mc_clinic_disease",
				"truncate table t_mc_clinic_exam",
				"truncate table t_mc_clinic_lab",
				"truncate table t_mc_clinic_order",
				"truncate table t_mc_clinic_patient"
		};
		for(String sql:sqls){
...
//		jdbcTemplate_oracle.update(sql);
	...
	public void cleardatezy(int database) {
		jdbcTemplate=dataBaseType.getJdbcTemplate(database);
		if(jdbcTemplate==null){
			log.info("数据库连接失败");
			return;
		...
		log.info("======>开始清理住院业务数据");
		String[] sqls={
				"truncate table t_mc_inhosp_allergen",
				"truncate table t_mc_inhosp_cost",
				"truncate table t_mc_inhosp_disease",
				"truncate table t_mc_inhosp_exam",
				"truncate table t_mc_inhosp_lab",
				"truncate table t_mc_inhosp_operation",
				"truncate table t_mc_inhosp_order",
				"truncate table t_mc_inhosp_patient",
				"truncate table t_mc_inhosp_temperature"
		};
		for(String sql:sqls){
			jdbcTemplate.update(sql);
		}
...
//		jdbcTemplate_oracle.update(sql);
	...
	public void cleardatecy(int database) {
		jdbcTemplate=dataBaseType.getJdbcTemplate(database);
		if(jdbcTemplate==null){
			log.info("数据库连接失败");
			return;
		...
		log.info("======>开始清理出院业务数据");
		String[] sqls={
				"truncate table t_mc_outhosp_allergen",
				"truncate table t_mc_outhosp_cost",
				"truncate table t_mc_outhosp_disease",
				"truncate table t_mc_outhosp_exam",
				"truncate table t_mc_outhosp_lab",
				"truncate table t_mc_outhosp_operation",
				"truncate table t_mc_outhosp_order",
				"truncate table t_mc_outhosp_patient",
				"truncate table t_mc_outhosp_temperature"
		};
		for(String sql:sqls){
			jdbcTemplate.update(sql);
		}
...
//	}
	...
	public void cleardict(int database) {
		jdbcTemplate=dataBaseType.getJdbcTemplate(database);
		if(jdbcTemplate==null){
			log.info("数据库连接失败");
			return;
		...
		log.info("======>开始清理字典表数据");
		String[] sqls={
				"truncate table mc_dict_allergen",
				"truncate table mc_dict_costitem",
				"truncate table mc_dict_dept",
				 "truncate table mc_dict_disease",
				 "truncate table mc_dict_doctor",
				 "truncate table mc_dict_drug",
				 "truncate table mc_dict_drug_sub",
				 "truncate table mc_dict_drug_pass",
				 "truncate table mc_dict_exam",
				 "truncate table mc_dict_frequency",
				 "truncate table mc_dict_labsub",
				 "truncate table mc_dict_lab",
				 "truncate table mc_dict_operation",
				 "truncate table mc_dict_route",
				 "truncate table Mdc2_dict_drug"
