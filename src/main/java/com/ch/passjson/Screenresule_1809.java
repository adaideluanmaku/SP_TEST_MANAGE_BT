...
@Service
public class Screenresule_1809 {
...
//				return "success";
			...
			//ShouldBlock
			if(!jsonin.get("ShouldBlock").equals(jsonin1.get("ShouldBlock"))&&moduleidstr==-1){
				listerr.add("ShouldBlock=====>"+jsonin.get("ShouldBlock"));
				listerr.add("ShouldBlock=====>"+jsonin1.get("ShouldBlock"));
//				return "success";
			}
			
			//ShowToDoctor
			if(!jsonin.get("ShowToDoctor").equals(jsonin1.get("ShowToDoctor"))&&moduleidstr==-1){
				listerr.add("ShowToDoctor=====>"+jsonin.get("ShowToDoctor"));
				listerr.add("ShowToDoctor=====>"+jsonin1.get("ShowToDoctor"));
//				return "success";
			}
			...
			for(int i=0;i<ScreenResultDrugs.size();i++){
				...
				for(int j=0;j<ScreenResultDrugs1.size();j++){
					...
					if(ScreenResultDrugsn.get("DrugIndex").equals(ScreenResultDrugsn1.get("DrugIndex"))
							 && ScreenResultDrugsn.get("DrugUniqueCode").equals(ScreenResultDrugsn1.get("DrugUniqueCode"))){
						DrugIndexstate=1;
						...
						if(!ScreenResultDrugsn.get("DrugName").equals(ScreenResultDrugsn1.get("DrugName"))){
							countsum=+1;
							listerr.add("DrugName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugName:"+ScreenResultDrugsn.get("DrugName"));
							listerr.add("DrugName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugName:"+ScreenResultDrugsn1.get("DrugName"));
						}
						if(!ScreenResultDrugsn.get("MenuLabel").equals(ScreenResultDrugsn1.get("MenuLabel"))){
							countsum=+1;
							listerr.add("MenuLabel=====>"+ScreenResultDrugsn.get("DrugIndex")+"--MenuLabel:"+ScreenResultDrugsn.get("MenuLabel"));
							listerr.add("MenuLabel=====>"+ScreenResultDrugsn.get("DrugIndex")+"--MenuLabel:"+ScreenResultDrugsn1.get("MenuLabel"));
						}
						if(!ScreenResultDrugsn.get("WarnType").equals(ScreenResultDrugsn1.get("WarnType"))){
							countsum=+1;
							listerr.add("WarnType=====>"+ScreenResultDrugsn.get("DrugIndex")+"--WarnType:"+ScreenResultDrugsn.get("WarnType"));
							listerr.add("WarnType=====>"+ScreenResultDrugsn.get("DrugIndex")+"--WarnType:"+ScreenResultDrugsn1.get("WarnType"));
						}
						if(!ScreenResultDrugsn.get("SubWarnType").equals(ScreenResultDrugsn1.get("SubWarnType"))){
							countsum=+1;
							listerr.add("SubWarnType=====>"+ScreenResultDrugsn.get("DrugIndex")+"--SubWarnType:"+ScreenResultDrugsn.get("SubWarnType"));
							listerr.add("SubWarnType=====>"+ScreenResultDrugsn.get("DrugIndex")+"--SubWarnType:"+ScreenResultDrugsn1.get("SubWarnType"));
						}
						if(!ScreenResultDrugsn.get("DrugSource").equals(ScreenResultDrugsn1.get("DrugSource"))){
							countsum=+1;
							listerr.add("DrugSource=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugSource:"+ScreenResultDrugsn.get("DrugSource"));
							listerr.add("DrugSource=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugSource:"+ScreenResultDrugsn1.get("DrugSource"));
						}
						if(!ScreenResultDrugsn.get("RouteCode").equals(ScreenResultDrugsn1.get("RouteCode"))){
							countsum=+1;
							listerr.add("RouteCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RouteCode:"+ScreenResultDrugsn.get("RouteCode"));
							listerr.add("RouteCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RouteCode:"+ScreenResultDrugsn1.get("RouteCode"));
						}
						if(!ScreenResultDrugsn.get("RouteCode").equals(ScreenResultDrugsn1.get("RouteCode"))){
							countsum=+1;
							listerr.add("RouteCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RouteCode:"+ScreenResultDrugsn.get("RouteCode"));
						...
						if(!ScreenResultDrugsn.get("RouteName").equals(ScreenResultDrugsn1.get("RouteName"))){
							countsum=+1;
							listerr.add("RouteName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RouteName:"+ScreenResultDrugsn.get("RouteName"));
							listerr.add("RouteName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RouteName:"+ScreenResultDrugsn1.get("RouteName"));
						}
						if(!ScreenResultDrugsn.get("DrugUniqueHash").equals(ScreenResultDrugsn1.get("DrugUniqueHash"))){
							countsum=+1;
							listerr.add("DrugUniqueHash=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugUniqueHash:"+ScreenResultDrugsn.get("DrugUniqueHash"));
							listerr.add("DrugUniqueHash=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DrugUniqueHash:"+ScreenResultDrugsn1.get("DrugUniqueHash"));
						}
						if(!ScreenResultDrugsn.get("ShouldBlock").equals(ScreenResultDrugsn1.get("ShouldBlock"))){
							countsum=+1;
							listerr.add("ShouldBlock=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ShouldBlock:"+ScreenResultDrugsn.get("ShouldBlock"));
							listerr.add("ShouldBlock=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ShouldBlock:"+ScreenResultDrugsn1.get("ShouldBlock"));
						}
						if(!ScreenResultDrugsn.get("ShowToDoctor").equals(ScreenResultDrugsn1.get("ShowToDoctor"))){
							countsum=+1;
							listerr.add("ShowToDoctor=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ShowToDoctor:"+ScreenResultDrugsn.get("ShowToDoctor"));
							listerr.add("ShowToDoctor=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ShowToDoctor:"+ScreenResultDrugsn1.get("ShowToDoctor"));
						}
						if(!ScreenResultDrugsn.get("ShowToDoctor").equals(ScreenResultDrugsn1.get("ShowToDoctor"))){
							countsum=+1;
							listerr.add("DetailReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DetailReason:"+ScreenResultDrugsn.get("DetailReason"));
							listerr.add("DetailReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DetailReason:"+ScreenResultDrugsn1.get("DetailReason"));
						}
						if(!ScreenResultDrugsn.get("IsNewWarning").equals(ScreenResultDrugsn1.get("IsNewWarning"))){
							countsum=+1;
							listerr.add("IsNewWarning=====>"+ScreenResultDrugsn.get("DrugIndex")+"--IsNewWarning:"+ScreenResultDrugsn.get("IsNewWarning"));
							listerr.add("IsNewWarning=====>"+ScreenResultDrugsn.get("DrugIndex")+"--IsNewWarning:"+ScreenResultDrugsn1.get("IsNewWarning"));
						}
						if(!ScreenResultDrugsn.get("RecomUsage").equals(ScreenResultDrugsn1.get("RecomUsage"))){
							countsum=+1;
							listerr.add("RecomUsage=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RecomUsage:"+ScreenResultDrugsn.get("RecomUsage"));
							listerr.add("RecomUsage=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RecomUsage:"+ScreenResultDrugsn1.get("RecomUsage"));
						}
						if(!ScreenResultDrugsn.get("RecomReason").equals(ScreenResultDrugsn1.get("RecomReason"))){
							countsum=+1;
							listerr.add("RecomReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RecomReason:"+ScreenResultDrugsn.get("RecomReason"));
							listerr.add("RecomReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--RecomReason:"+ScreenResultDrugsn1.get("RecomReason"));
						}
						if(!ScreenResultDrugsn.get("ImportantLabItems").equals(ScreenResultDrugsn1.get("ImportantLabItems"))){
							countsum=+1;
							listerr.add("ImportantLabItems=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ImportantLabItems:"+ScreenResultDrugsn.get("ImportantLabItems"));
							listerr.add("ImportantLabItems=====>"+ScreenResultDrugsn.get("DrugIndex")+"--ImportantLabItems:"+ScreenResultDrugsn1.get("ImportantLabItems"));
						}
						if(!ScreenResultDrugsn.get("DeptCode").equals(ScreenResultDrugsn1.get("DeptCode"))){
							countsum=+1;
							listerr.add("DeptCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DeptCode:"+ScreenResultDrugsn.get("DeptCode"));
							listerr.add("DeptCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DeptCode:"+ScreenResultDrugsn1.get("DeptCode"));
						}
						if(!ScreenResultDrugsn.get("DeptName").equals(ScreenResultDrugsn1.get("DeptName"))){
							countsum=+1;
							listerr.add("DeptName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DeptName:"+ScreenResultDrugsn.get("DeptName"));
							listerr.add("DeptName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DeptName:"+ScreenResultDrugsn1.get("DeptName"));
						}
						if(!ScreenResultDrugsn.get("DoctorCode").equals(ScreenResultDrugsn1.get("DoctorCode"))){
							countsum=+1;
							listerr.add("DoctorCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DoctorCode:"+ScreenResultDrugsn.get("DoctorCode"));
							listerr.add("DoctorCode=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DoctorCode:"+ScreenResultDrugsn1.get("DoctorCode"));
						}
						if(!ScreenResultDrugsn.get("DoctorName").equals(ScreenResultDrugsn1.get("DoctorName"))){
							countsum=+1;
							listerr.add("DoctorName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DoctorName:"+ScreenResultDrugsn.get("DoctorName"));
							listerr.add("DoctorName=====>"+ScreenResultDrugsn.get("DrugIndex")+"--DoctorName:"+ScreenResultDrugsn1.get("DoctorName"));
						}
						if(!ScreenResultDrugsn.get("HasPassReason").equals(ScreenResultDrugsn1.get("HasPassReason"))){
							countsum=+1;
							listerr.add("HasPassReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--HasPassReason:"+ScreenResultDrugsn.get("HasPassReason"));
							listerr.add("HasPassReason=====>"+ScreenResultDrugsn.get("DrugIndex")+"--HasPassReason:"+ScreenResultDrugsn1.get("HasPassReason"));
						}
						if(countsum > 0){
							break;
						}
...
//						JSONArray ScreenResults1=ScreenResultDrugsn1.getJSONArray("ScreenResults");
						...
						for(int namesum=0;namesum<ScreenResultsdan.size();namesum++){
							...
							String name=null;
							if(moduleidstr==obj.getInt("ModuleID")||moduleidstr==-1){
								name=obj.getString("ModuleID")+":"+obj.getString("ModuleName")+":"+obj.getString("Slcode");
								modulnames.add(name);
							}
						}
						//
						...
						for(int namesum1=0;namesum1<ScreenResultsdan1.size();namesum1++){
							...
							if(moduleidstr==obj1.getInt("ModuleID")||moduleidstr==-1){
								name1=obj1.getString("ModuleID")+":"+obj1.getString("ModuleName")+":"+obj1.getString("Slcode");
						...
						if(modulnames.size()!=0&&modulnames1.size()!=0){
							Screenresule_1809_two jsonshuchu1=new Screenresule_1809_two();
							jsonshuchu1.setJson(ScreenResultsdan);
							jsonshuchu1.setJson1(ScreenResultsdan1);
							jsonshuchu1.setModuleidstr(moduleidstr);
							jsonshuchu1.setDrugindex(ScreenResultDrugsn.get("DrugIndex").toString());
...
//							
//							//
//							if(moduleidstr==ScreenResult.getInt("ModuleID")||moduleidstr==-1){
//								int sum=0;//
//								String err=null;
//								String err1=null;
//								int ksum=0;//
...
//									}
//									
//									listerr.add("DrugIndex=====>"+ScreenResultDrugsn.get("DrugIndex")+":"+ScreenResultDrugsn.get("DrugName")+",ScreenResults :"+errnamelist);
//									listerr.add("DrugIndex=====>"+ScreenResultDrugsn.get("DrugIndex")+":"+ScreenResultDrugsn.get("DrugName")+",ScreenResults-error :"+errnamelist1+"<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp=========Show Errors=========");
