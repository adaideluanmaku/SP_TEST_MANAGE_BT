...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/works/works_zhouhuibao.js"></script>
...
<input id="level" type="hidden" value="${sessionScope.user.level }">
<div id="wrapper" >
	<div  class="gray-bg">
		<div id="header_path" class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				<ol class="breadcrumb">
					<li><a>home</a></li>
					<li><a>工作计划</a></li>
					<li class="active"><strong>周汇报</strong></li>
				</ol>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">工作汇报</h4>
			</div>
			<div class="modal-body" style="height:400px;overflow:auto">
				<form class="form-horizontal" role="form" id="dialog_form">
					<input type="hidden" id="workzhouhuibaoid" name="workzhouhuibaoid" value="">
					<div class="form-group">
			            <label for="submittime" class="col-sm-2 control-label">汇报时间</label>
			            <div class="col-sm-4">
			            	<div class="input-group date" id="submittime" name="submittime">  
				                <input type="text" class="form-control" />  
				                <span class="input-group-addon">  
				                    <span class="glyphicon glyphicon-calendar"></span>  
				                </span>  
					...
					<div class="form-group">
						<label for="worktext" class="col-sm-2 control-label">汇报内容</label>
						<div class="col-sm-10">
							<textarea class="col-sm-12" rows="15" id="worktext" name="worktext"></textarea>
						</div>
					</div>
				</form>
			</div>
...
<div class="modal fade" id="modal_dialog_look" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" height="600px">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			...
			<div class="modal-body" style="height:400px;overflow:auto">
				...
				<div class="row">
					<label for="worktext" class="col-sm-2 control-label">汇报内容</label>
					<div class="col-sm-10">
						<textarea class="col-sm-12" rows="15" id="worktext" name="worktext" readonly="readonly"></textarea>
					</div>
				</div>
			</div>
			<div class="modal-footer">
