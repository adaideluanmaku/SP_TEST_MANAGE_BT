...
<!-- MY JS -->
<script type="text/javascript" src="${pageContext.request.contextPath}/chjs/sysmanage/serverip.js"></script>
		...
		<div id="header_path" class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				<ol class="breadcrumb">
					<li><a>home</a></li>
					<li><a>系统管理</a></li>
					<li class="active"><strong>访问地址</strong></li>
				</ol>
			</div>
			...
			<div id="table_div" class="panel-body" style="padding-bottom:0px;">
				<div id="search_div" class="panel panel-default">
				    ...
				    <div class="panel-body">
				    	<div class="col-sm-5">
			                <label class="control-label col-sm-4" for="search_data" style="padding-top:7px">服务地址名称</label>
			                <div class="col-sm-8">
			...
			<div class="modal-body" style="height:400px;overflow:auto">
				<form class="form-horizontal" role="form" id="dialog_form">
					...
					<div class="form-group">
						<label for="servername" class="col-sm-3 control-label">服务地址名称</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="servername"  name="servername">
						</div>
					</div>
					<div class="form-group">
						<label for="serveraddress" class="col-sm-3 control-label">服务地址</label>
						<div class="col-sm-9">
							<textarea class="col-sm-12" rows="10" id="serveraddress" name="serveraddress"></textarea>
						</div>
					</div>
				</form>
			</div>
